 ...
 */
export function checkoutsControllerV1Retrieve(
  client: CreemCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CheckoutsControllerV1RetrieveRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "CheckoutsControllerV1_retrieve",
    oAuth2Scopes: [],
