 ...
 */
export function productsControllerV1Create(
  client: CreemCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ProductsControllerV1CreateRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "ProductsControllerV1_create",
    oAuth2Scopes: [],
