 ...
 * Delete a discount.
 */
export function discountsControllerV1Delete(
  client: CreemCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DiscountsControllerV1DeleteRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "DiscountsControllerV1_delete",
    oAuth2Scopes: [],
