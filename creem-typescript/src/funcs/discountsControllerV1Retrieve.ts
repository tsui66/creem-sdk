 ...
 * Retrieve discount
 */
export function discountsControllerV1Retrieve(
  client: CreemCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DiscountsControllerV1RetrieveRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "DiscountsControllerV1_retrieve",
    oAuth2Scopes: [],
