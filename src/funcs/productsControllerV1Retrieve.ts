 ...
 * Retrieve a product
 */
export function productsControllerV1Retrieve(
  client: CreemCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ProductsControllerV1RetrieveRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "ProductsControllerV1_retrieve",
    oAuth2Scopes: [],
