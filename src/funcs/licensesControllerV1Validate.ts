 ...
 */
export function licensesControllerV1Validate(
  client: CreemCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.LicensesControllerV1ValidateRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "LicensesControllerV1_validate",
    oAuth2Scopes: [],
