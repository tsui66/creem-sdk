 ...
 */
export function subscriptionsControllerV1Cancel(
  client: CreemCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SubscriptionsControllerV1CancelRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "SubscriptionsControllerV1_cancel",
    oAuth2Scopes: [],
