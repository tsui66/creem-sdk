 ...
 * Create a discount.
 */
export function discountsControllerV1Create(
  client: CreemCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DiscountsControllerV1CreateRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "DiscountsControllerV1_create",
    oAuth2Scopes: [],
