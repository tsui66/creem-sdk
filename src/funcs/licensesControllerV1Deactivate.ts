 ...
 */
export function licensesControllerV1Deactivate(
  client: CreemCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.LicensesControllerV1DeactivateRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "LicensesControllerV1_deactivate",
    oAuth2Scopes: [],
