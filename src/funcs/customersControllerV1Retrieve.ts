 ...
 * Retrieve a customer
 */
export function customersControllerV1Retrieve(
  client: CreemCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CustomersControllerV1RetrieveRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "CustomersControllerV1_retrieve",
    oAuth2Scopes: [],
