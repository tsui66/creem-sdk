 ...
 */
export function subscriptionsControllerV1Retrieve(
  client: CreemCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SubscriptionsControllerV1RetrieveRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "SubscriptionsControllerV1_retrieve",
    oAuth2Scopes: [],
