 ...
 */
export function subscriptionsControllerV1Update(
  client: CreemCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SubscriptionsControllerV1UpdateRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "SubscriptionsControllerV1_update",
    oAuth2Scopes: [],
