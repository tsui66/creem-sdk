 ...
 */
export function licensesControllerV1Activate(
  client: CreemCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.LicensesControllerV1ActivateRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "LicensesControllerV1_activate",
    oAuth2Scopes: [],
