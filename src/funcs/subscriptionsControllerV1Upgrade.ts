 ...
 */
export function subscriptionsControllerV1Upgrade(
  client: CreemCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SubscriptionsControllerV1UpgradeRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "SubscriptionsControllerV1_upgrade",
    oAuth2Scopes: [],
