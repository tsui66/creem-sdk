 ...
 * List all products
 */
export function productsControllerV1Search(
  client: CreemCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ProductsControllerV1SearchRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "ProductsControllerV1_search",
    oAuth2Scopes: [],
